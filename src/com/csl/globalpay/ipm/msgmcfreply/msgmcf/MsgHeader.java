 ...
 */
package com.csl.globalpay.ipm.msgmcfreply.msgmcf;
import java.io.IOException;

import com.comforte.csl.cslapi.CSLInputStream;
import com.comforte.csl.cslapi.CSLOutputStream;
import com.comforte.csl.xmlutils.CSLTypes;
import com.csl.globalpay.ipm.msgmcfreply.msgmcf.ErrStatus;
import com.csl.globalpay.ipm.msgmcfreply.msgmcf.UserData;
...
public class	MsgHeader implements com.comforte.csl.cslapi.CSLStreamable
{
   ...
   /**
    * <code>
    * MaskingFlg is a text String of1 bytes.
    * </code>
    */
   public String getMaskingFlg()
   {
      return maskingFlg;
   }
    ...
    * </code>
    */
   public void setMaskingFlg(String theMaskingFlg)
   {
       maskingFlg = theMaskingFlg;
   }
   ...
   /**
    * <code>
    * SiteProdInd is a text String of256 bytes.
    * </code>
    */
   ...
   public void write(CSLOutputStream out) throws IOException
   {
      ...
      out.writeString(getMaskingFlg(),1, CSLTypes.PICX);
      getUserData().write(out);
      out.writeString(getSiteProdInd(),256, CSLTypes.PICX);
   ...
   public void read(CSLInputStream in) throws IOException
   {
      ...
      setMaskingFlg(in.readString(1));
      getUserData().read(in);
      setSiteProdInd(in.readString(256));
