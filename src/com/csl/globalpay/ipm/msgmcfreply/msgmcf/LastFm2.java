...
public class	LastFm2 implements com.comforte.csl.cslapi.CSLStreamable
{
   ...
   /**
    * <code>
    * CrncyTxt is a text String of3 bytes.
    * </code>
    */
   public String getCrncyTxt()
   {
      return crncyTxt;
   }
    ...
    * </code>
    */
   public void setCrncyTxt(String theCrncyTxt)
   {
       crncyTxt = theCrncyTxt;
   }
   ...
   public void write(CSLOutputStream out) throws IOException
   {
      ...
      out.writeString(getCrncyTxt(),3, CSLTypes.PICX);
      out.writeString(getFiller(),961, CSLTypes.PICX);
   }
   ...
   public void read(CSLInputStream in) throws IOException
   {
      ...
      setCrncyTxt(in.readString(3));
      setFiller(in.readString(961));
   } 
}
