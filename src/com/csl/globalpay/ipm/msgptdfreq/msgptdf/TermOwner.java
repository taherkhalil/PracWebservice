...
public class	TermOwner implements com.comforte.csl.cslapi.CSLStreamable
{
   ...
   /**
    * <code>
    * RetailerGrp is a text String of4 bytes.
    * </code>
    */
   ...
   /**
    * <code>
    * RetailerRegn is a text String of4 bytes.
    * </code>
    */
   ...
   public void write(CSLOutputStream out) throws IOException
   {
      ...
      out.writeString(getRetailerGrp(),4, CSLTypes.PICX);
      out.writeString(getRetailerRegn(),4, CSLTypes.PICX);
   ...
   public void read(CSLInputStream in) throws IOException
   {
      ...
      setRetailerGrp(in.readString(4));
      setRetailerRegn(in.readString(4));
