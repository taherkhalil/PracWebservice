...
public class	ClerkTots implements com.comforte.csl.cslapi.CSLStreamable
{
   ...
   /**
    * <code>
    * Name=CHK-AMT;CSL Type=cslLong;
    * </code>
    */
   public Long getChkAmt()
   {
      return chkAmt;
   }
    ...
    * </code>
    */
   public void setChkAmt(Long theChkAmt)
   {
       chkAmt = theChkAmt;
   }
   ...
   public void write(CSLOutputStream out) throws IOException
   {
      ...
      out.writeLong(getChkAmt().longValue());
   }
   ...
   public void read(CSLInputStream in) throws IOException
   {
      ...
      setChkAmt(new Long(in.readLong()));
   } 
}
