...
import com.csl.globalpay.ipm.msgptdfreply.msgptdf.LastFm;
import com.csl.globalpay.ipm.msgptdfreply.msgptdf.MsgHeader;
import com.csl.globalpay.ipm.msgptdfreply.msgptdf.RecImage;

/** <code>Msgptdf</code>
 *  
 */
public class	Msgptdf implements com.comforte.csl.cslapi.CSLStreamable
{
   /* Members */
    ...
    */
   public Msgptdf(String characterEncoding)
   {
